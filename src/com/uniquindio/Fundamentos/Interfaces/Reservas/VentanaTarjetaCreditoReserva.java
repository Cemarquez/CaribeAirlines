...
public class VentanaTarjetaCreditoReserva extends JFrame implements ActionListener {
	...
	private VentanaPagarReserva miVentanaPago;
	private JMonthChooser monthChooser;
	private Cliente miCliente;
	private JYearChooser yearChooser;
	private Reserva reserva;

	public VentanaTarjetaCreditoReserva(VentanaPrincipal miVentanaPrincipal, VentanaPagarReserva miVentanaPago, Cliente miCliente, Reserva reserva) {
		...
		lblNewLabel.setIcon(new ImageIcon(VentanaTarjetaCreditoReserva.class.getResource("/imagenes/none.png")));
