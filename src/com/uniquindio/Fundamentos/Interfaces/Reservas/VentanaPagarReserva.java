...
public class VentanaPagarReserva extends JFrame implements ActionListener {
	...
	public VentanaPagarReserva(Reserva reserva, VentanaPrincipal miVentanaPrincipal, Cliente miCliente) {
		Silla silla = reserva.getSilla();
		sillas.add(silla);
		Pasajero pasajero = reserva.getPasajero();
		pasajeros.add(pasajero);
		this.reserva = reserva;
		this.vueloSeleccionado = reserva.getVueloSeleccionado();
	...
	public void constPanelSuperior() {
		...
		JLabel labelInfo = new JLabel(
				"Encuentra acontinuaci\u00F3n la informaci\u00F3n relacionada con tu compra.                                                        ");
	...
	public void constPanelDestinoOrigen() {
		...
		label.setIcon(new ImageIcon(VentanaPagarReserva.class.getResource("/imagenes/plane.png")));
		panel_1.add(label);

		JLabel label_1 = new JLabel("");
		panel_1.add(label_1);
		JLabel labelOrigen = new JLabel(
				vueloSeleccionado.getTrayecto().getOrigen() + " - " + vueloSeleccionado.getTrayecto().getDestino());
	...
	public void constPanelShidorris() {
		...
		labelCheck.setIcon(new ImageIcon(
				VentanaPagarReserva.class.getResource("/imagenes/icons8-marca-de-verificaci\u00F3n-48.png")));
		...
		gl_panelPrincipal.setHorizontalGroup(gl_panelPrincipal.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelPrincipal.createSequentialGroup()
						.addComponent(panelCheck, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		...
		gl_panelPrincipal.setVerticalGroup(gl_panelPrincipal.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelPrincipal.createSequentialGroup()
						.addGroup(gl_panelPrincipal.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(layeredPane, Alignment.LEADING).addComponent(panelCheck,
										Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE))
						.addContainerGap()));
		GroupLayout gl_panelCheck = new GroupLayout(panelCheck);
		gl_panelCheck.setHorizontalGroup(gl_panelCheck.createParallelGroup(Alignment.TRAILING).addComponent(label)
				.addComponent(label_1).addGroup(Alignment.LEADING, gl_panelCheck.createSequentialGroup().addGap(19)
						.addComponent(labelCheck).addContainerGap(23, Short.MAX_VALUE)));
		gl_panelCheck.setVerticalGroup(gl_panelCheck.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelCheck.createSequentialGroup()
						.addGroup(gl_panelCheck.createParallelGroup(Alignment.LEADING).addComponent(label)
		...
		JLabel lblHoraLlegada = new JLabel(
				Util.sumarHoras(vueloSeleccionado.getHoraSalida(), vueloSeleccionado.getTrayecto().getDuracionMin()));
		...
		JLabel lblDuracion = new JLabel("0 Minutos     ");
		lblDuracion.setBounds(207, 25, 96, 14);
		...
		label_3.setIcon(
				new ImageIcon(VentanaPagarReserva.class.getResource("/imagenes/icons8-carrito-de-compras-24.png")));

		JLabel lblNewLabel_1 = new JLabel("Selecciona tu m\u00E9todo de pago");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 11));

		botonTarjeta = new JRadioButton("");
		botonTarjeta.setSelected(true);
		...
		label_5.setIcon(new ImageIcon(VentanaPagarReserva.class.getResource("/imagenes/icons8-visa-64.png")));
				...
				.setHorizontalGroup(
						gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
										.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 416,
												GroupLayout.PREFERRED_SIZE)
								...
								.addGroup(gl_contentPane.createSequentialGroup().addGap(19)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_contentPane.createSequentialGroup().addGap(12)
														.addComponent(botonTarjeta).addGap(18)
														.addComponent(lblTarjetaDeCrditodebito))
												.addComponent(lblNewLabel_1))
										.addPreferredGap(ComponentPlacement.RELATED, 364, Short.MAX_VALUE)
										.addComponent(label_5).addGap(68))
								.addGroup(gl_contentPane
										.createSequentialGroup().addGap(19).addComponent(label_3)
										.addPreferredGap(
												ComponentPlacement.RELATED)
										.addComponent(lblResumenDelPago).addContainerGap(513, Short.MAX_VALUE))
								.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addGroup(
										gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
												.createSequentialGroup().addGap(10).addComponent(lblPesoAdicionalEn)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(textFieldKilosAdicionales, GroupLayout.PREFERRED_SIZE, 45,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNewLabel_3)
												.addGap(18).addComponent(lblenEstaCompra).addGap(2)
												.addComponent(LabelKilosQuePuedeLLevar)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblKilos))
												.addComponent(panelPrincipal, GroupLayout.DEFAULT_SIZE, 665,
														Short.MAX_VALUE))
										.addContainerGap())
								.addGroup(gl_contentPane
										.createSequentialGroup().addGap(256).addComponent(btnContinuar,
												GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE)
										.addContainerGap(321, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup()
				.addComponent(panelResumenVuelo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(panelPrincipal, GroupLayout.PREFERRED_SIZE, 87, GroupLayout.PREFERRED_SIZE).addGap(6)
				.addGroup(
						gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_contentPane.createSequentialGroup()
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblPesoAdicionalEn)
												.addComponent(textFieldKilosAdicionales, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addComponent(lblNewLabel_3).addComponent(lblenEstaCompra)
												.addComponent(LabelKilosQuePuedeLLevar).addComponent(lblKilos))
										.addGap(10)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblResumenDelPago).addComponent(label_3))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 84,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(lblNewLabel_1).addGap(39)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
												.addComponent(lblTarjetaDeCrditodebito, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(botonTarjeta, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
								.addComponent(label_5))
				.addPreferredGap(ComponentPlacement.RELATED, 74, Short.MAX_VALUE)
				.addComponent(btnContinuar, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE).addGap(28)));
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel_2.createSequentialGroup().addComponent(lblPreciosBoletos)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblPrecio)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblcop))
								.addGroup(gl_panel_2.createSequentialGroup().addComponent(lblPrecioServicios)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(labelPrecioEquipaje)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblcop_1))
								.addGroup(gl_panel_2.createSequentialGroup().addComponent(lblTotalAPagar)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(labelPrecioTotal)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblcopincluye)))
						.addContainerGap(112, Short.MAX_VALUE)));
		gl_panel_2.setVerticalGroup(

				gl_panel_2.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_2.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(lblPreciosBoletos)
								.addComponent(lblPrecio).addComponent(lblcop))
						.addGap(2)
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(lblPrecioServicios)
								.addComponent(labelPrecioEquipaje).addComponent(lblcop_1))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(separator_1, GroupLayout.PREFERRED_SIZE, 2, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(lblTotalAPagar)
								.addComponent(labelPrecioTotal).addComponent(lblcopincluye))
		...
		if (e.getSource() == btnContinuar) {
			if(textFieldKilosAdicionales.getText().equalsIgnoreCase("") || textFieldKilosAdicionales.getText()== null || !Util.isNumeroString(textFieldKilosAdicionales.getText()) || Util.leerEnteros(textFieldKilosAdicionales.getText()) >= avion.getKilosDisponibles()) {
				...
				if (botonTarjeta.isSelected()) {
					...
					VentanaTarjetaCreditoReserva miVTC = new VentanaTarjetaCreditoReserva(miVentanaPrincipal, this,
							miCliente, reserva);
					miVTC.setVisible(true);
					this.dispose();
				} else {
					JOptionPane.showMessageDialog(null, "Por favor seleccione un método de pago.", "Error",
