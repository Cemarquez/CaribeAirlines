...
import com.uniquindio.Fundamentos.Interfaces.VentanaRegistrar;
...
public class VentanaModificarTripulante extends JFrame implements ActionListener {

	private JPanel contentPane;
	private JPanel  datos, panel, panel_1, panel_2, panel_7;
	...
	private VentanaListaTripulantes miVLT;
	private JDateChooser dateChooser;
	/**
	 * Launch the application.
	 */

	public VentanaModificarTripulante(Tripulante tripulante, VentanaPrincipal miVentanaPrincipal, VentanaListaTripulantes miVLT) {
	...
	public void constPanelMedio()
	{
		...
		}
		{
			...
			panel_1.add(panel_7);
			{
				nN = new JTextField(tripulante.getNombre());
				panel_7.add(nN);
				nN.setColumns(17);
			}
		}
		...
		}
		{
			...
			panel_1.add(panel_8);
			{
				aA = new JTextField(tripulante.getApellido());
				panel_8.add(aA);
				aA.setColumns(17);
			}
		}
		...
		}
		{
			...
			panel_1.add(panel_9);
			{
				cC = new JTextField(tripulante.getId());
				panel_9.add(cC);
				cC.setColumns(17);
			}
		}
		...
		}
		{
			...
			{
				direc = new JTextField(tripulante.getDireccion());
				panel_10.add(direc);
				direc.setColumns(17);
			}
		}
		...
		}
		{
			...
			{
				email = new JTextField(tripulante.getCorreo());
				panel_12.add(email);
				email.setColumns(17);
			}
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnListo) {
			if (nombre.equals("") || apellido.equals("") || correo.equals("") || direccion.equals("")
					 || cedula.equals("") || fechaNacimiento.equals("")) {
				...
				if (mather.find() == false) {
					...
					if(miVentanaPrincipal.correoRegistrado(correo) == true)
					{
						...
						tripulante.actualizarDatos(cedula, nombre, apellido, direccion, correo, fechaNacimiento);
