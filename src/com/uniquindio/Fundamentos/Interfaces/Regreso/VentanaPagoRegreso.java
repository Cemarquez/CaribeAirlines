...
public class VentanaPagoRegreso extends JFrame implements ActionListener{
	...
	public VentanaPagoRegreso(ArrayList<Pasajero> pasajeros, Vuelo vueloSeleccionado, ArrayList<Silla> sillas, Cliente miCliente, VentanaPrincipal miVentanaPrincipal, String modalidad, String fechaaRegreso) {
		this.sillas = sillas;
	...
	public void constPanelDestinoOrigen()
	{
		...
		label.setIcon(new ImageIcon(VentanaPagoRegreso.class.getResource("/imagenes/plane.png")));
		panel_1.add(label);
	...
	public void constPanelShidorris() {
		...
		labelCheck.setIcon(new ImageIcon(VentanaPagoRegreso.class.getResource("/imagenes/icons8-marca-de-verificaci\u00F3n-48.png")));
		...
		label_3.setIcon(new ImageIcon(VentanaPagoRegreso.class.getResource("/imagenes/icons8-carrito-de-compras-24.png")));
		...
		label_4.setIcon(new ImageIcon(VentanaPagoRegreso.class.getResource("/imagenes/icons8-reserva-50.png")));
		
		JLabel label_5 = new JLabel("");
		label_5.setIcon(new ImageIcon(VentanaPagoRegreso.class.getResource("/imagenes/icons8-visa-64.png")));
			...
			if(textFieldKilosAdicionales.getText().equalsIgnoreCase("") || textFieldKilosAdicionales.getText()== null || !Util.isNumeroString(textFieldKilosAdicionales.getText()) || Util.leerEnteros(textFieldKilosAdicionales.getText()) >= avion.getKilosDisponibles()) {
				...
				else
				{
					...
					if(botonTarjeta.isSelected())
					{
						...
						VentanaTarjetaCreditoRegreso miVTC = new VentanaTarjetaCreditoRegreso(miVentanaPrincipal, this, miCliente);
