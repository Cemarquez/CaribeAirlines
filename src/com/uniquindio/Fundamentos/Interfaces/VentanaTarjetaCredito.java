...
public class VentanaTarjetaCredito extends JFrame implements ActionListener {
	...
	private VentanaPago miVentanaPago;
	private JMonthChooser monthChooser;
	private Cliente miCliente;
	private JYearChooser yearChooser;
	private String modalidad;
	public VentanaTarjetaCredito(VentanaPrincipal miVentanaPrincipal, VentanaPago miVentanaPago, Cliente miCliente, String modalidad) {
		...
		lblNewLabel.setIcon(new ImageIcon(VentanaTarjetaCredito.class.getResource("/imagenes/none.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		Vuelo vuelo = miVentanaPago.getVueloSeleccionado();
		   ...
		   miVentanaPrincipal.añadirFacturaAerolinea(factura);
			...
			VentanaResultadosBusquedaRegreso miVenatanaRBR = new VentanaResultadosBusquedaRegreso(miVentanaPrincipal, miVentanaPago, cliente);
			miVenatanaRBR.setVisible(true);
			this.dispose();
			}
			else
			{
